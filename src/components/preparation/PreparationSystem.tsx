...
export function PreparationSystem() {
  const [expandedId, setExpandedId] = React.useState<string | null>(demoData.preparationAreas[3].id) // Default open CN
          ...
          <div className="lg:col-span-5 flex flex-col gap-12 lg:sticky lg:top-32">
            <div>
              ...
              <h2 className="text-3xl font-bold text-primary-text mb-4">
                Turn skill gaps into a preparation plan.
              </h2>
                  ...
                  >
                    <div className="p-4 sm:p-5 flex items-center justify-between gap-4">
                      ...
                      <button 
                        ...
                        aria-label={`${isExpanded ? 'Collapse' : 'Expand'} ${area.name} details`}
                      >
                        ...
                        >
                          <div className="px-4 sm:px-5 pb-5 pt-2 border-t border-border/50 bg-surface/30 flex flex-col gap-6">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pt-5 border-t border-border/50 mt-2">
                              ...
                              <Button variant="primary" size="lg" className="w-full sm:w-auto shrink-0 group font-bold tracking-wide shadow-md">
